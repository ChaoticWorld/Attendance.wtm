...
namespace em_wtm.DataAccess
{
    public class DataContext : FrameworkContext
    {
        ...
        #region Attendance
        public DbSet<Attendance2SchemeClass> Attendance2SchemeClasses { get; set; }
        public DbSet<Attendance2DayType> Attendance2DayType { get; set; }
        public DbSet<Attendance2PlanTime> Attendance2PlanTime { get; set; }
        public DbSet<Attendance2Holiday> Attendance2Holiday { get; set; }
        public DbSet<Attendance2FeeCalculator> Attendance2FeeCalculator { get; set; }
        public DbSet<Attendance2EmployeeRefSchemeClass> Attendance2EmployeeRefSchemeClass { get; set; }
        public DbSet<Attendance2PlanRefClass> Attendance2PlanRefClass { get; set; }
        public DbSet<Attendance2Record> Attendance2Record { get; set; }
        public DbSet<Attendance2EventDeclared> Attendance2EventDeclared { get; set; }
        public DbSet<VAttendanceEmployee> VAttendanceEmployee { get; set; }
        public DbSet<VAttendanceReport> VAttendanceReport { get; set; }
        #endregion

        #region Report
        public DbSet<ReportScript> ReportScripts { get; set; }
        public DbSet<ReportMain> ReportMains { get; set; }
        public DbSet<ReportParamOperatorEnum> ReportParamOperatorEnums { get; set; }
        public DbSet<ReportPermission> ReportPermissions { get; set; }
        public DbSet<ReportScriptParam> ReportScriptParams { get; set; }
        public DbSet<ReportScriptTypeEnum> ReportScriptTypeEnums { get; set; }
        #endregion
